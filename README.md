...
//a função "downloader" faz o download dos videos retornados da função "fetchyt", ela pede dois parametros cujo o primeiro é o objeto retornado com os dados dos videos e o 
//segundo é um objeto indicando onde o video será salvo.
